...
const Invoice = (props: InvoiceProps) => {
  ...
  //       document.body.innerHTML = printContents; // Thay thế nội dung hiện tại bằng phần cần in
  //       window.print(); // Gọi chức năng in
  //       document.body.innerHTML = originalContents; // Khôi phục nội dung sau khi in
  //     }
  //   };
